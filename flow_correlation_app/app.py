...
st.markdown("""
    ...
    <div style='text-align: center; color: #00FFA3; font-family: "Orbitron", sans-serif; font-size: 3rem; font-weight: 700; letter-spacing: 2px; margin-bottom: 10px;'>
        Multiphase Flow Correlation Predictor
    </div>
    <div style='text-align: center; color: #C9D1D9; font-size: 18px; margin-bottom: 20px;'>
