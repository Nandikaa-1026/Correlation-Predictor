...
st.markdown("""
    ...
    <div style='text-align: center; color: #FF79A1; font-family: "Nunito", sans-serif; font-size: 3rem; font-weight: 800; letter-spacing: 0px; margin-bottom: 10px;'>
        Multiphase Flow Correlation Predictor
    </div>
    <div style='text-align: center; color: #4A4063; font-size: 18px; margin-bottom: 20px;'>
        Upload a dataset or manually enter parameters to instantly generate AI-driven predictions.
    </div>
    <hr style='border-color: #F0EBF8;'>
